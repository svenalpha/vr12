...
function Home() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "vr12        Home          no 16      21:07     27/02/2024 " }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: addAndMultiply(1, 2, 3) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: multiplyAndAdd(1, 2, 3) })
  ] });
}
...
function ToProxy() {
  ...
  function getData() {
    axios$1.get(urlProxy).then((res) => setData(res.data)).catch((error) => {
      console.log("urlProxy = ,catch error = ", urlProxy, error);
    });
    axios$1.get(urlProxy2).then((res) => setData2(res.data)).catch((error2) => {
