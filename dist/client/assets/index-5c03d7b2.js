...
function Home() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "vr12        Home          no 19      17:43    29/02/2024 " }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: addAndMultiply(1, 2, 3) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: multiplyAndAdd(1, 2, 3) })
  ] });
}
...
function ToProxy() {
  ...
  async function getData() {
    await axios$1.get(urlProxy).then((res) => setData(res.data)).catch((error) => {
      console.log("urlProxy = ,catch error = ", urlProxy, error);
    });
    await axios$1.get(urlProxy2).then((res) => setData2(res.data)).catch((error2) => {
      console.log("urlProxy2 = ,catch error2 = ", urlProxy2, error2);
    });
    await axios$1.get(urlProxy3).then((res) => setData3(res.data)).catch((error3) => {
